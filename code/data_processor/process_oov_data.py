...
def construct_normal_vocab(input_file,
    ...
    with open(output_idmap_file, 'w') as fout:
...
def process_oov_words(train_file='../user_data/official_data/train.tsv',
                      test_file='../user_data/official_data/testB.tsv',
    ...
    process_oov_file(train_file, os.path.join(output_dir, 'train.tsv'), normal_vocab, idmap,
                     mode='train')
    process_oov_file(test_file, os.path.join(output_dir, 'test.tsv'), normal_vocab, idmap,
                     mode='test')
