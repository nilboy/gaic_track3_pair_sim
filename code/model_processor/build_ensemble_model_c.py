...
ensemble_model = EnsembleModel.init_from_models_path([
    "../user_data/mlm/bert-base/outputs",
    "../user_data/mlm/macbert-base/outputs",
    "../user_data/mlm/roberta-base/outputs",
    ...
    "../user_data/mlm/roberta-large/outputs",
    "../user_data/mlm/roberta-base_fgm/outputs"
], ["bert"]*9)
